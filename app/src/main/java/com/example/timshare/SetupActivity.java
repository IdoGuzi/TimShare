...
//            userMap.put("relationshipstatus", "none");
    ...
    private void SendUserToMainActivity() {
        Intent mainIntent = new Intent(SetupActivity.this, CalendarActivity.class);
...
//                        Toast.makeText(SetupActivity.this, "Error occur: " + massage, Toast.LENGTH_LONG).show();
//                    }
//                }
//            });
//        }
...
//                                        Intent selfIntent = new Intent(SetupActivity.this,SetupActivity.class);
//                                        startActivity(selfIntent);
//                                        Toast.makeText(SetupActivity.this, "image stored to filrebase", Toast.LENGTH_SHORT).show();
//                                    } else {
//                                        String massage = task.getException().getMessage();
...
//        Intent calIntent = new Intent(SetupActivity.this, CalendarActivity.class);
//        calIntent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
